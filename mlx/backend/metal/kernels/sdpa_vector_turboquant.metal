...
instantiate_sdpa_vector_tq(float16_t, half, 256, 4, 2);
instantiate_sdpa_vector_tq(bfloat16_t, bfloat16_t, 64, 4, 2);
instantiate_sdpa_vector_tq(bfloat16_t, bfloat16_t, 128, 4, 2);
instantiate_sdpa_vector_tq(bfloat16_t, bfloat16_t, 256, 4, 2);
instantiate_sdpa_vector_tq(float, float, 64, 4, 2);
instantiate_sdpa_vector_tq(float, float, 128, 4, 2);
instantiate_sdpa_vector_tq(float, float, 256, 4, 2);

// Mixed: 2-bit keys, 4-bit values
instantiate_sdpa_vector_tq(float16_t, half, 64, 2, 4);
instantiate_sdpa_vector_tq(float16_t, half, 128, 2, 4);
instantiate_sdpa_vector_tq(float16_t, half, 256, 2, 4);
instantiate_sdpa_vector_tq(bfloat16_t, bfloat16_t, 64, 2, 4);
instantiate_sdpa_vector_tq(bfloat16_t, bfloat16_t, 128, 2, 4);
instantiate_sdpa_vector_tq(bfloat16_t, bfloat16_t, 256, 2, 4);
instantiate_sdpa_vector_tq(float, float, 64, 2, 4);
instantiate_sdpa_vector_tq(float, float, 128, 2, 4);
instantiate_sdpa_vector_tq(float, float, 256, 2, 4);
...
instantiate_sdpa_vector_tq_2pass_1(float16_t, half, 256, 2, 2);
...
instantiate_sdpa_vector_tq_2pass_1(bfloat16_t, bfloat16_t, 256, 4, 2);
instantiate_sdpa_vector_tq_2pass_1(float, float, 64, 4, 2);
instantiate_sdpa_vector_tq_2pass_1(float, float, 128, 4, 2);
instantiate_sdpa_vector_tq_2pass_1(float, float, 256, 4, 2);

// Mixed: 2-bit keys, 4-bit values
instantiate_sdpa_vector_tq_2pass_1(float16_t, half, 64, 2, 4);
instantiate_sdpa_vector_tq_2pass_1(float16_t, half, 128, 2, 4);
instantiate_sdpa_vector_tq_2pass_1(float16_t, half, 256, 2, 4);
instantiate_sdpa_vector_tq_2pass_1(bfloat16_t, bfloat16_t, 64, 2, 4);
instantiate_sdpa_vector_tq_2pass_1(bfloat16_t, bfloat16_t, 128, 2, 4);
instantiate_sdpa_vector_tq_2pass_1(bfloat16_t, bfloat16_t, 256, 2, 4);
instantiate_sdpa_vector_tq_2pass_1(float, float, 64, 2, 4);
instantiate_sdpa_vector_tq_2pass_1(float, float, 128, 2, 4);
instantiate_sdpa_vector_tq_2pass_1(float, float, 256, 2, 4);
